...
class BarangController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($barangs)
            ...
            ->addIndexColumn()
            ->addColumn('aksi', function ($barangs) { // menambahkan kolom aksi
                $btn =  '<button onclick="modalAction(\'' . url('/barang/' . $barangs->barang_id . '/show_ajax') . '\')" class="btn btn-info btn-sm">Detail</button> ';
                $btn .= '<button onclick="modalAction(\'' . url('/barang/' . $barangs->barang_id . '/edit_ajax') . '\')" class="btn btn-warning btn-sm">Edit</button> ';
                $btn .= '<button onclick="modalAction(\'' . url('/barang/' . $barangs->barang_id . '/delete_ajax') . '\')" class="btn btn-danger btn-sm">Hapus</button> ';
                return $btn;
            })
